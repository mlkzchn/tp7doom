...
# options passed: -mtune=generic -march=x86-64 -g -fasynchronous-unwind-tables -fstack-protector-strong -fstack-clash-protection -fcf-protection
	.text
.Ltext0:
	.file 0 "/home/astrid/Documents/enseignements/DOOM/linuxdoom-1.10" "p_tick.c"
	.section	.rodata
	.align 32
	.type	rcsid, @object
	.size	rcsid, 49
...
# p_tick.c:55:     thinkercap.prev = thinkercap.next  = &thinkercap;
	.loc 1 55 40
	leaq	thinkercap(%rip), %rax	#, tmp83
	movq	%rax, 8+thinkercap(%rip)	# tmp83, thinkercap.next
# p_tick.c:55:     thinkercap.prev = thinkercap.next  = &thinkercap;
	.loc 1 55 33
	movq	8+thinkercap(%rip), %rax	# thinkercap.next, _1
# p_tick.c:55:     thinkercap.prev = thinkercap.next  = &thinkercap;
	.loc 1 55 21
	movq	%rax, thinkercap(%rip)	# _1, thinkercap.prev
# p_tick.c:56: }
	.loc 1 56 1
	nop	
	popq	%rbp	#
...
.LFB1:
	...
	movq	%rsp, %rbp	#,
	.cfi_def_cfa_register 6
	movq	%rdi, -8(%rbp)	# thinker, thinker
# p_tick.c:67:     thinkercap.prev->next = thinker;
	.loc 1 67 15
	movq	thinkercap(%rip), %rax	# thinkercap.prev, _1
# p_tick.c:67:     thinkercap.prev->next = thinker;
	.loc 1 67 27
	movq	-8(%rbp), %rdx	# thinker, tmp84
	movq	%rdx, 8(%rax)	# tmp84, _1->next
# p_tick.c:68:     thinker->next = &thinkercap;
	.loc 1 68 19
	movq	-8(%rbp), %rax	# thinker, tmp85
	leaq	thinkercap(%rip), %rdx	#, tmp86
	movq	%rdx, 8(%rax)	# tmp86, thinker_4(D)->next
# p_tick.c:69:     thinker->prev = thinkercap.prev;
	.loc 1 69 31
	movq	thinkercap(%rip), %rdx	# thinkercap.prev, _2
# p_tick.c:69:     thinker->prev = thinkercap.prev;
	.loc 1 69 19
	movq	-8(%rbp), %rax	# thinker, tmp87
	movq	%rdx, (%rax)	# _2, thinker_4(D)->prev
# p_tick.c:70:     thinkercap.prev = thinker;
	.loc 1 70 21
	movq	-8(%rbp), %rax	# thinker, tmp88
	movq	%rax, thinkercap(%rip)	# tmp88, thinkercap.prev
# p_tick.c:71: }
	.loc 1 71 1
	nop	
	popq	%rbp	#
...
.LFB2:
	...
	.cfi_def_cfa_register 6
	movq	%rdi, -8(%rbp)	# thinker, thinker
# p_tick.c:83:   thinker->function.acv = (actionf_v)(-1);
	.loc 1 83 25
	movq	-8(%rbp), %rax	# thinker, tmp82
	movq	$-1, 16(%rax)	#, thinker_2(D)->function.acv
# p_tick.c:84: }
	.loc 1 84 1
	nop	
	popq	%rbp	#
...
.LFB4:
	...
	.cfi_def_cfa_register 6
	subq	$16, %rsp	#,
# p_tick.c:105:     currentthinker = thinkercap.next;
	.loc 1 105 20
	movq	8+thinkercap(%rip), %rax	# thinkercap.next, tmp89
	movq	%rax, -8(%rbp)	# tmp89, currentthinker
# p_tick.c:106:     while (currentthinker != &thinkercap)
	.loc 1 106 11
	jmp	.L6	#
.L9:
# p_tick.c:108: 	if ( currentthinker->function.acv == (actionf_v)(-1) )
	.loc 1 108 31
	movq	-8(%rbp), %rax	# currentthinker, tmp90
	movq	16(%rax), %rax	# currentthinker_8->function.acv, _1
# p_tick.c:108: 	if ( currentthinker->function.acv == (actionf_v)(-1) )
	.loc 1 108 5
	cmpq	$-1, %rax	#, _1
	jne	.L7	#,
# p_tick.c:111: 	    currentthinker->next->prev = currentthinker->prev;
	.loc 1 111 20
	movq	-8(%rbp), %rax	# currentthinker, tmp91
	movq	8(%rax), %rax	# currentthinker_8->next, _2
# p_tick.c:111: 	    currentthinker->next->prev = currentthinker->prev;
	.loc 1 111 49
	movq	-8(%rbp), %rdx	# currentthinker, tmp92
	movq	(%rdx), %rdx	# currentthinker_8->prev, _3
# p_tick.c:111: 	    currentthinker->next->prev = currentthinker->prev;
	.loc 1 111 33
	movq	%rdx, (%rax)	# _3, _2->prev
# p_tick.c:112: 	    currentthinker->prev->next = currentthinker->next;
	.loc 1 112 20
	movq	-8(%rbp), %rax	# currentthinker, tmp93
	movq	(%rax), %rax	# currentthinker_8->prev, _4
# p_tick.c:112: 	    currentthinker->prev->next = currentthinker->next;
	.loc 1 112 49
	movq	-8(%rbp), %rdx	# currentthinker, tmp94
	movq	8(%rdx), %rdx	# currentthinker_8->next, _5
# p_tick.c:112: 	    currentthinker->prev->next = currentthinker->next;
	.loc 1 112 33
	movq	%rdx, 8(%rax)	# _5, _4->next
# p_tick.c:113: 	    Z_Free (currentthinker);
	.loc 1 113 6
	movq	-8(%rbp), %rax	# currentthinker, tmp95
	movq	%rax, %rdi	# tmp95,
	call	Z_Free@PLT	#
	jmp	.L8	#
.L7:
# p_tick.c:117: 	    if (currentthinker->function.acp1)
	.loc 1 117 34
	movq	-8(%rbp), %rax	# currentthinker, tmp96
	movq	16(%rax), %rax	# currentthinker_8->function.acp1, _6
# p_tick.c:117: 	    if (currentthinker->function.acp1)
	.loc 1 117 9
	testq	%rax, %rax	# _6
	je	.L8	#,
# p_tick.c:118: 		currentthinker->function.acp1 (currentthinker);
	.loc 1 118 27
	movq	-8(%rbp), %rax	# currentthinker, tmp97
	movq	16(%rax), %rdx	# currentthinker_8->function.acp1, _7
# p_tick.c:118: 		currentthinker->function.acp1 (currentthinker);
	.loc 1 118 3
	movq	-8(%rbp), %rax	# currentthinker, tmp98
	movq	%rax, %rdi	# tmp98,
	call	*%rdx	# _7
.LVL0:
.L8:
# p_tick.c:120: 	currentthinker = currentthinker->next;
	.loc 1 120 17
	movq	-8(%rbp), %rax	# currentthinker, tmp99
	movq	8(%rax), %rax	# currentthinker_8->next, tmp100
	movq	%rax, -8(%rbp)	# tmp100, currentthinker
.L6:
# p_tick.c:106:     while (currentthinker != &thinkercap)
	.loc 1 106 27
	leaq	thinkercap(%rip), %rax	#, tmp101
	cmpq	%rax, -8(%rbp)	# tmp101, currentthinker
	jne	.L9	#,
# p_tick.c:122: }
	.loc 1 122 1
	nop	
...
.LFB5:
	...
	.cfi_def_cfa_register 6
	subq	$16, %rsp	#,
# p_tick.c:135:     if (paused)
	.loc 1 135 9
	movl	paused(%rip), %eax	# paused, paused.0_1
# p_tick.c:135:     if (paused)
	.loc 1 135 8
	testl	%eax, %eax	# paused.0_1
	jne	.L17	#,
# p_tick.c:139:     if ( !netgame
	.loc 1 139 10
	movl	netgame(%rip), %eax	# netgame, netgame.1_2
# p_tick.c:139:     if ( !netgame
	.loc 1 139 8
	testl	%eax, %eax	# netgame.1_2
	jne	.L13	#,
# p_tick.c:140: 	 && menuactive
	.loc 1 140 3
	movl	menuactive(%rip), %eax	# menuactive, menuactive.2_3
	testl	%eax, %eax	# menuactive.2_3
	je	.L13	#,
# p_tick.c:141: 	 && !demoplayback
	.loc 1 141 6
	movl	demoplayback(%rip), %eax	# demoplayback, demoplayback.3_4
# p_tick.c:141: 	 && !demoplayback
	.loc 1 141 3
	testl	%eax, %eax	# demoplayback.3_4
	jne	.L13	#,
# p_tick.c:142: 	 && players[consoleplayer].viewz != 1)
	.loc 1 142 28
	movl	consoleplayer(%rip), %eax	# consoleplayer, consoleplayer.4_5
	movslq	%eax, %rdx	# consoleplayer.4_5, tmp92
	movq	%rdx, %rax	# tmp92, tmp94
	salq	$2, %rax	#, tmp94
	addq	%rdx, %rax	# tmp92, tmp94
	salq	$6, %rax	#, tmp95
	movq	%rax, %rdx	# tmp94, tmp93
	leaq	20+players(%rip), %rax	#, tmp96
	movl	(%rdx,%rax), %eax	# players[consoleplayer.4_5].viewz, _6
# p_tick.c:142: 	 && players[consoleplayer].viewz != 1)
	.loc 1 142 3
	cmpl	$1, %eax	#, _6
	jne	.L18	#,
.L13:
# p_tick.c:148:     for (i=0 ; i<MAXPLAYERS ; i++)
	.loc 1 148 11
	movl	$0, -4(%rbp)	#, i
# p_tick.c:148:     for (i=0 ; i<MAXPLAYERS ; i++)
	.loc 1 148 5
	jmp	.L14	#
.L16:
# p_tick.c:149: 	if (playeringame[i])
	.loc 1 149 18
	movl	-4(%rbp), %eax	# i, tmp98
	cltq
	leaq	0(,%rax,4), %rdx	#, tmp99
	leaq	playeringame(%rip), %rax	#, tmp100
	movl	(%rdx,%rax), %eax	# playeringame[i_11], _7
# p_tick.c:149: 	if (playeringame[i])
	.loc 1 149 5
	testl	%eax, %eax	# _7
	je	.L15	#,
# p_tick.c:150: 	    P_PlayerThink (&players[i]);
	.loc 1 150 6
	...
	salq	$6, %rax	#, tmp104
	leaq	players(%rip), %rdx	#, tmp105
	addq	%rdx, %rax	# tmp105, _8
	movq	%rax, %rdi	# _8,
...
# p_tick.c:148:     for (i=0 ; i<MAXPLAYERS ; i++)
	...
	cmpl	$3, -4(%rbp)	#, i
	jle	.L16	#,
# p_tick.c:152:     P_RunThinkers ();
	.loc 1 152 5
	call	P_RunThinkers	#
# p_tick.c:153:     P_UpdateSpecials ();
	.loc 1 153 5
	call	P_UpdateSpecials@PLT	#
# p_tick.c:154:     P_RespawnSpecials ();
	.loc 1 154 5
	call	P_RespawnSpecials@PLT	#
# p_tick.c:157:     leveltime++;	
	.loc 1 157 14
	movl	leveltime(%rip), %eax	# leveltime, leveltime.5_9
	addl	$1, %eax	#, _10
	movl	%eax, leveltime(%rip)	# _10, leveltime
	jmp	.L10	#
.L17:
# p_tick.c:136: 	return;
	.loc 1 136 2
